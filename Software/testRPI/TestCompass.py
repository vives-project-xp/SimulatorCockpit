...
airspeed_canvas.pack(side="left", padx=50, pady=20)
...
compass_canvas.pack(side="right", padx=50, pady=20)
...
def on_message(client, userdata, msg):
    global airspeed_value, heading_value
